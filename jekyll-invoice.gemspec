...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "Produce invoices with Jekyll"
  spec.description   = "A collection of Jekyll plugins and conventions to produce nice HTML invoices."
  ...
  spec.add_runtime_dependency "jekyll", ">= 4.2.2", "< 4.4.0"
